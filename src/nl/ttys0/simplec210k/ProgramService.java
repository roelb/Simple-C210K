...
public class ProgramService extends Service {
	...
	private void startWorkout() {
		...
		if (selectedProgram.contains("w1")) {
			...
			for (int i = 0; i < 4; i++) {
				if (running)
					countdown(10 * 60, 500, "Jogging", "Jog for ");
			...
			totalTimeLeft = 52 * 60 * 1000;
			if (running)
				countdown(5 * 60, 500, "Warmup", "Warmup: Brisk walk for ");

			for (int i = 0; i < 2; i++) {
				if (running)
					countdown(15 * 60, 500, "Jogging", "Jog for ");
		...
		// w3
			...
			for (int i = 0; i < 2; i++) {
				if (running)
					countdown(17 * 60, 500, "Jogging", "Jog for ");
		...
		// w4
			...
			for (int i = 0; i < 2; i++) {
				if (running)
					countdown(18 * 60, 500, "Jogging", "Jog for ");
		...
		// w5
			...
			if (selectedProgram.equals("w5d1")) {
				totalTimeLeft = 50 * 60 * 1000;
				if (running)
					countdown(5 * 60, 500, "Warmup", "Warmup: Brisk walk for ");

				if (running)
					countdown(22 * 60, 500, "Jogging", "Jog for ");
				if (running)
					countdown(60, 500, "Walking", "Walk for ");
				if (running)
					countdown(22 * 60, 500, "Jogging", "Jog for ");
			...
			if (selectedProgram.equals("w5d2")) {
				totalTimeLeft = 56 * 60 * 1000;
				if (running)
					countdown(5 * 60, 500, "Warmup", "Warmup: Brisk walk for ");

				if (running)
					countdown(25 * 60, 500, "Jogging", "Jog for ");
				if (running)
					countdown(60, 500, "Walking", "Walk for ");
				if (running)
					countdown(25 * 60, 500, "Jogging", "Jog for ");
			...
			if (selectedProgram.equals("w5d3")) {
				totalTimeLeft = 66 * 60 * 1000;
				if (running)
					countdown(5 * 60, 500, "Warmup", "Warmup: Brisk walk for ");

				if (running)
					countdown(30 * 60, 500, "Jogging", "Jog for ");
				if (running)
					countdown(60, 500, "Walking", "Walk for ");
				if (running)
					countdown(30 * 60, 500, "Jogging", "Jog for ");
		...
		// w6
			...
			totalTimeLeft = 65 * 60 * 1000;
			if (running)
				countdown(5 * 60, 500, "Warmup", "Warmup: Brisk walk for ");
			if (running)
				countdown(60 * 60, 500, "Jogging", "Jog for ");
		}
