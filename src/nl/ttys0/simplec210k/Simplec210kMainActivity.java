...
public class Simplec210kMainActivity extends ListActivity {
	TextView selection;
	...
	static String[] programStringArr = new String[18]; // workout name
	static Boolean[] programDoneArr = new Boolean[18]; // workout completed?
	...
	public void onCreate(Bundle icicle) {
		...
		ProgressDialog dialog = ProgressDialog.show(
				Simplec210kMainActivity.this, "", "Loading. Please wait...",
				true);
	...
	class IconicAdapter extends ArrayAdapter<String> {
		...
		IconicAdapter() {
			super(Simplec210kMainActivity.this, R.layout.row, programStringArr);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (Boolean
					.valueOf(Simplec210kMainActivity.programDoneArr[position])) {
